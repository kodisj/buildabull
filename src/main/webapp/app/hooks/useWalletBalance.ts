...
import algodClient from 'app/shared/lib/algodClient'
import { formatPrice } from 'app/shared/util'
...
export default function useWalletBalance() {
  ...
  const { data: accountInfo } = useQuery({"queryKey":['balance', activeAccount?.address], "queryFn":getAccountInfo, 
