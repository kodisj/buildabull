...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nft-mint.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NFTMINT_LIST actions', async () => {
    ...
    it('dispatches FETCH_NFTMINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NFTMINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NFTMINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NFTMINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NFTMINT actions', async () => {
      const expectedActions = [
        {
