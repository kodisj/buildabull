    ...
    <div className="bg-white py-16 sm:py-24">
      <div className="relative sm:py-16">
        ...
        <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
          <div ref={inputRef} className="relative rounded-2xl px-6 py-10 bg-indigo-600 overflow-hidden shadow-xl sm:px-12 sm:py-20">
            ...
            <div className="relative">
              <div className="sm:text-center">
                ...
                <p className="mt-6 mx-auto max-w-2xl text-lg text-indigo-200">
                  Upload an encrypted file that you want to decrypt, then type the password to the input field which we can use for the
                  decryption. After these, you can click on the decrypt button to download the decrypted file.
                </p>
              </div>
              <div className="mt-12 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300  border-dashed rounded-md">
                <div className="space-y-1 text-center">
                  <svg className="mx-auto h-12 w-12 text-gray-100" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                    <path
