            ...
            <div className="relative">
              <div className="sm:text-center">
                ...
                <p className="mt-6 mx-auto max-w-2xl text-lg text-indigo-200">
                  Upload a file that you want to encrypt, then type a password to the input field which we can use for the encryption. After
                  these, you can click on the encrypt button to download the encrypted file.
                </p>
              </div>
